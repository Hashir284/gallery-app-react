...
const Signup = () => {
  ...
  const [loadingProvider, setLoadingProvider] = useState(null) // tracks 'google' or 'github'
    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-slate-950 text-slate-100">
      <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-2xl">
        ...
        <div className="relative my-6 flex items-center justify-center">
          ...
          <span className="absolute bg-slate-900 px-3 text-[10px] uppercase font-mono tracking-widest text-slate-500">or register with</span>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <button
            ...
            className="flex items-center justify-center py-3 bg-slate-950 hover:bg-slate-950/80 border border-slate-800 rounded-xl transition-all disabled:opacity-40 cursor-pointer"
            title="Google"
          >
            {loadingProvider === 'google' ? (
              <span className="text-xs text-slate-400 border-2 border-amber-400 border-t-transparent rounded-full w-4 h-4 animate-spin"></span>
            ) : (
